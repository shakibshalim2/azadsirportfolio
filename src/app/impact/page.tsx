    ...
    <>
      ...
      >
        <div className="absolute inset-0">
          ...
          <div className="absolute left-1/3 top-1/4 h-[300px] w-[300px] sm:h-[500px] sm:w-[500px] rounded-full bg-green-500/10 blur-[150px]" />
      ...
      <section className="relative bg-dark-900 section-padding">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-grid opacity-20" />
          <div className="absolute right-0 top-1/3 h-[300px] w-[300px] sm:h-[500px] sm:w-[500px] rounded-full bg-green-500/5 blur-[150px]" />
        </div>
