  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute left-1/4 top-0 h-[300px] w-[300px] sm:h-[500px] sm:w-[500px] rounded-full bg-accent-500/5 blur-[150px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid items-center gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-24">
          <motion.div
            ...
            className="relative order-2 lg:order-1 mx-auto w-full max-w-sm sm:max-w-md lg:max-w-none"
          >
            ...
            {/* Floating badge - positioned relative to outer container */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.5, duration: 0.6 }}
              className="absolute right-0 sm:-right-2 top-4 sm:top-8 glass rounded-lg sm:rounded-xl p-2 sm:p-4 md:-right-6 z-10"
            >
            ...
            <motion.div
              ...
              className="absolute left-0 sm:-left-2 bottom-24 sm:bottom-10 glass rounded-lg sm:rounded-xl p-2 sm:p-4 md:-left-6 z-10"
            >
